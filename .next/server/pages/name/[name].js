...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1534);
/* harmony import */ var _components_layouts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6999);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9361);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_api__WEBPACK_IMPORTED_MODULE_4__, _utils__WEBPACK_IMPORTED_MODULE_6__]);
([_api__WEBPACK_IMPORTED_MODULE_4__, _utils__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const PokemonName = ({ pokemon  })=>{
    const [isInFavorires, setIsInFavorires] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(_utils__WEBPACK_IMPORTED_MODULE_6__/* .localFavorites.existInFavorites */ .q.existInFavorites(pokemon.id));
    const handleOnToggleFavorite = ()=>{
        _utils__WEBPACK_IMPORTED_MODULE_6__/* .localFavorites.toggleFavorites */ .q.toggleFavorites(pokemon.id);
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_layouts__WEBPACK_IMPORTED_MODULE_5__/* .Layout */ .A, {
        title: pokemon.name,
...
const getStaticPaths = async (ctx)=>{
    const { data  } = await _api__WEBPACK_IMPORTED_MODULE_4__/* .pokeApi.get */ .T.get("pokemon?limit=151");
...
const getStaticProps = async ({ params  })=>{
    const { name  } = params;
    const pokemon = await (0,_utils__WEBPACK_IMPORTED_MODULE_6__/* .getPokemonInfo */ .w)(name);
    if (!pokemon) {
        return {
            redirect: {
                destination: "/",
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PokemonName);
...
var __webpack_exports__ = __webpack_require__.X(0, [121,676,61,588,361], () => (__webpack_exec__(2221)));
